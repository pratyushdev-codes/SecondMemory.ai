...
function useWaitForComponentMount(component) {
  const watcherRef = (0, import_react28.useRef)();
  const [status, setStatus] = (0, import_react28.useState)("rendering");
...
var ClerkHostRenderer = class extends import_react30.default.PureComponent {
  constructor() {
    super(...arguments);
    this.rootRef = import_react30.default.createRef();
  }
  ...
  render() {
    ...
    return import_react30.default.createElement(import_react30.default.Fragment, null, !hideRootHtmlElement && import_react30.default.createElement("div", { ...rootAttributes }), this.props.children);
  }
};
...
var SignIn = withClerk(
  ({ clerk, component, fallback, ...props }) => {
    ...
    return import_react21.default.createElement(import_react21.default.Fragment, null, shouldShowFallback && fallback, clerk.loaded && import_react21.default.createElement(
      ClerkHostRenderer,
      {
        component,
...
var _UserProfile = withClerk(
  ({
    ...
    return import_react21.default.createElement(import_react21.default.Fragment, null, shouldShowFallback && fallback, import_react21.default.createElement(
      ClerkHostRenderer,
      {
        component,
...
var _UserButton = withClerk(
  ({
    ...
    return import_react21.default.createElement(UserButtonContext.Provider, { value: passableProps }, shouldShowFallback && fallback, clerk.loaded && import_react21.default.createElement(
      ClerkHostRenderer,
      {
        component,
        ...passableProps,
...
function UserButtonOutlet(outletProps) {
  ...
  return import_react21.default.createElement(ClerkHostRenderer, { ...portalProps });
}
...
var _OrganizationSwitcher = withClerk(
  ({
    ...
    return import_react21.default.createElement(OrganizationSwitcherContext.Provider, { value: passableProps }, import_react21.default.createElement(import_react21.default.Fragment, null, shouldShowFallback && fallback, clerk.loaded && import_react21.default.createElement(
      ClerkHostRenderer,
      {
        ...passableProps,
        hideRootHtmlElement: !!props.__experimental_asProvider
...
function ClerkContextProvider(props) {
  ...
  const clerkCtx = import_react37.default.useMemo(() => ({ value: clerk }), [clerkLoaded2]);
  const clientCtx = import_react37.default.useMemo(() => ({ value: state.client }), [state.client]);
  const {
    sessionId,
    session,
    userId,
  ...
  const authCtx = import_react37.default.useMemo(() => {
    const value = {
      sessionId,
      userId,
      actor,
  ...
  const sessionCtx = import_react37.default.useMemo(() => ({ value: session }), [sessionId, session]);
  const userCtx = import_react37.default.useMemo(() => ({ value: user }), [userId, user]);
  const organizationCtx = import_react37.default.useMemo(() => {
    const value = {
      organization
    };
    return { value };
  ...
  return (
    ...
    import_react37.default.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, import_react37.default.createElement(ClientContext.Provider, { value: clientCtx }, import_react37.default.createElement(SessionContext.Provider, { value: sessionCtx }, import_react37.default.createElement(OrganizationProvider, { ...organizationCtx.value }, import_react37.default.createElement(AuthContext.Provider, { value: authCtx }, import_react37.default.createElement(UserContext.Provider, { value: userCtx }, children))))))
  );
}
var useLoadedIsomorphicClerk = (options) => {
  const [loaded, setLoaded] = import_react37.default.useState(false);
  const isomorphicClerk = import_react37.default.useMemo(() => IsomorphicClerk.getOrCreateInstance(options), []);
  import_react37.default.useEffect(() => {
